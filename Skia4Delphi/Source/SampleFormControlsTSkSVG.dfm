inherited frmTSkSVG: TfrmTSkSVG
  ClientHeight = 604
  ExplicitWidth = 368
  TextHeight = 15
  inherited pnlContent: TPanel
    ...
    inherited sbxContent: TScrollBox
      ...
      object pnlCBuilder: TPanel
        ...
        ShowCaption = False
        TabOrder = 1
        OnClick = pnlCBuilderClick
        ExplicitWidth = 312
        DesignSize = (
          316
          50)
        object lblCBuilderDescription: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 25
          Width = 300
          ...
          Words = <
            item
              Caption = 'See the sample loading the asset'#39's file "c++builder.svg"'
            end>
          ExplicitTop = 21
          ExplicitWidth = 278
        end
        object lblCBuilderTitle: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 6
          Width = 300
          ...
          Words = <
            item
              Caption = 'c++builder.svg'
            end>
          ExplicitTop = 2
          ExplicitWidth = 278
        end
        object svgCBuilderArrow: TSkSvg
          Left = 303
          Top = 17
          Width = 16
          Height = 16
      ...
      object pnlEditingElement: TPanel
        AlignWithMargins = True
        Left = 20
        Top = 121
        Width = 316
        ...
        DesignSize = (
          316
          50)
        object lblEditingElementDescription: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 25
          Width = 300
          ...
          Words = <
            item
              Caption = 'Example editing just one element of the SVG'
            end>
          ExplicitTop = 21
          ExplicitWidth = 278
        end
        object lblEditingElementTitle: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 6
          Width = 300
          ...
          Words = <
            item
              Caption = 'Editing an SVG Element'
            end>
          ExplicitTop = 2
          ExplicitWidth = 278
        end
        object svgEditingElementArrow: TSkSvg
          Left = 303
          Top = 17
          Width = 16
          Height = 16
        ...
        object pnlEditingElementLine: TPanel
          Left = 0
          Top = 49
          Width = 316
          Height = 1
      ...
      object pnlCustomColor: TPanel
        ...
        DesignSize = (
          316
          50)
        object lblCustomColorDescription: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 25
          Width = 300
          ...
          Words = <
            item
              Caption = 'Load an svg icon overriding the original color'
            end>
          ExplicitTop = 31
          ExplicitWidth = 295
        end
        object lblCustomColorTitle: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 6
          Width = 300
        ...
        object svgCustomColorArrow: TSkSvg
          Left = 303
          Top = 17
          Width = 16
          Height = 16
        ...
        object pnlCustomColorLine: TPanel
          Left = 0
          Top = 49
          Width = 316
          Height = 1
      ...
      object pnlTileWrapMode: TPanel
        ...
        DesignSize = (
          316
          50)
        object lblTileWrapModeDescription: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 25
          Width = 300
          ...
          Words = <
            item
              Caption = 'Show an svg image with tile wrap mode'
            end>
          ExplicitTop = 31
          ExplicitWidth = 295
        end
        object lblTileWrapModeTitle: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 6
          Width = 300
          ...
          Words = <
            item
              Caption = 'Tile Wrap Mode'
            end>
          ExplicitTop = 2
          ExplicitWidth = 278
        end
        object svgTileWrapModeArrow: TSkSvg
          Left = 303
          Top = 17
          Width = 16
          Height = 16
        ...
        object pnlTileWrapModeLine: TPanel
          Left = 0
          Top = 49
          Width = 316
          Height = 1
