...
void __fastcall TfrmPathsAndEffects::pnlComposedPathEffectClick(TObject* Sender)
{
...
void __fastcall TfrmPathsAndEffects::pnlDiscretePathEffectClick(TObject* Sender)
{
...
void __fastcall TfrmPathsAndEffects::pnlPathFillTypesClick(TObject* Sender)
{
...
void __fastcall TfrmPathsAndEffects::pnlRoundingSharpCornersClick(TObject* Sender)
{
...
void __fastcall TfrmPathsAndEffects::pnlShadersClick(TObject* Sender)
{
...
void __fastcall TfrmPathsAndEffects::pnlSumPathEffectClick(TObject* Sender)
{
