inherited frmImage: TfrmImage
  ...
  inherited pnlContent: TPanel
    ...
    inherited sbxContent: TScrollBox
      ExplicitWidth = 352
      ExplicitHeight = 524
      object pnlEncodeWebpVsJpeg: TPanel
        ...
        ShowCaption = False
        TabOrder = 0
        OnClick = pnlEncodeWebpVsJpegClick
        ExplicitWidth = 312
        DesignSize = (
          316
          50)
        object lblEncodeWebpVsJpegDescription: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 25
          Width = 300
          ...
          Words = <
            item
              Caption = 'Learn how to encode and see the compression comparison'
            end>
          ExplicitTop = 21
          ExplicitWidth = 278
        end
        object lblEncodeWebpVsJpegTitle: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 6
          Width = 300
        ...
        object svgEncodeWebpVsJpegArrow: TSkSvg
          Left = 303
          Top = 17
          Width = 16
          Height = 16
        ...
        object pnlEncodeWebpVsJpegLine: TPanel
          Left = 0
          Top = 49
          Width = 316
          Height = 1
      ...
      object pnlNinePatch: TPanel
        ...
        ShowCaption = False
        TabOrder = 1
        OnClick = pnlNinePatchClick
        ExplicitWidth = 312
        DesignSize = (
          316
          50)
        object lblNinePatchDescription: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 25
          Width = 300
          ...
          Words = <
            item
              Caption = 'Draw an image preserving the corners from strech'
            end>
          ExplicitTop = 21
          ExplicitWidth = 278
        end
        object lblNinePatchTitle: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 6
          Width = 300
          ...
          Words = <
            item
              Caption = 'Drawing 9-Patch'
            end>
          ExplicitTop = 2
          ExplicitWidth = 278
        end
        object svgNinePatchArrow: TSkSvg
          Left = 303
          Top = 17
          Width = 16
          Height = 16
        ...
        object pnlNinePatchLine: TPanel
          Left = 0
          Top = 49
          Width = 316
          Height = 1
      ...
      object pnlWebpInImage: TPanel
        ...
        ShowCaption = False
        TabOrder = 2
        OnClick = pnlWebpInImageClick
        ExplicitWidth = 312
        DesignSize = (
          316
          50)
        object lblWebpInImageDescription: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 25
          Width = 300
          ...
          Words = <
            item
              Caption = 'With Skia4Delphi installed you can load many new formats'
            end>
          ExplicitTop = 31
          ExplicitWidth = 295
        end
        object lblWebpInImageTitle: TSkLabel
          AlignWithMargins = True
          Left = 0
          Top = 6
          Width = 300
          ...
          Words = <
            item
              Caption = 'Load .webp directly in TImage'
            end>
          ExplicitTop = 2
          ExplicitWidth = 278
        end
        object svgWebpInImageArrow: TSkSvg
          Left = 303
          Top = 17
          Width = 16
          Height = 16
        ...
        object pnlWebpInImageLine: TPanel
          Left = 0
          Top = 49
          Width = 316
          Height = 1
