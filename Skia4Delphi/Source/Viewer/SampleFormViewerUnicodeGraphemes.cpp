...
void TfrmUnicodeGraphemesViewer::Show(const String ATitle,
	const String ADescription, const String AText,
	const String AGraphemesDescription)
{
	lblResult->Words->ItemByName["Text"]->Caption      = "\"" + AText + "\"";
	lblResult->Words->ItemByName["Length"]->Caption    = IntToStr(AText.Length());
