...
enum class TSide {Top, Left, Bottom, Right};
typedef StaticArray<TPointF, 4> TCornersF;
...
void __fastcall TfrmTransforms::pnl3DRotationClick(TObject* Sender)
{
...
TCornersF CornersF(const TRectF& Rect)
{
	return TCornersF{
...
void __fastcall TfrmTransforms::pnlStrechedCornersClick(TObject* Sender)
{
...
void __fastcall TfrmTransforms::pnlTaperTransformClick(TObject* Sender)
{
	TViewerOptions* LOptions = new TViewerOptions();
